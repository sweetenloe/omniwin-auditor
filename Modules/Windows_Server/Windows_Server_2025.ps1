...
$traitement = Get-Content $nomfichierNetAccount |Select-String -pattern '(DurA''AAe du verrouillage)|(Lockout duration)'
...
$traitement = Get-Content $nomfichierNetAccount |Select-String -pattern "(FenA'AAatre d'observation du verrouillage)|(Lockout observation window)"
...
$traitement = Get-Content $auditconfigfile |Select-String -pattern "(OpA'AArations de ticket du service Kerberos)|(Kerberos Service Ticket Operations)"
$traitement = $traitement.line
...
$traitement = Get-Content $auditconfigfile |Select-String -pattern "(AccA'AA s au service d'annuaire)|(Audit Directory Service Access)"
$traitement = $traitement.line
...
$traitement = Get-Content $auditconfigfile |Select-String -pattern "(Partage de fichiers dA'AAtaillA'AA)|(Audit Detailed File Share)"
$traitement = $traitement.line 
...
$traitement = Get-Content $auditconfigfile |Select-String -pattern "(Autres A'AAvA'AAnements d'accA''AA s A''AA  l'objet)|(Audit Other Object Access Events)"
$traitement = $traitement.line 
...
$traitement = Get-Content $auditconfigfile |Select-String -pattern "(Autres A'AAvA'AAnements de modification de stratA'AAgie)|(Audit Other Policy Change Events)"
$traitement = $traitement.line 
